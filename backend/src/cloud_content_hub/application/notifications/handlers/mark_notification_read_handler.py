"""Mark notification read command handler."""
...
from cloud_content_hub.application.notifications.commands import MarkNotificationReadCommand
from cloud_content_hub.application.notifications.dto.responses import NotificationResponseDto
from cloud_content_hub.application.notifications.events import NotificationRead
...
class MarkNotificationReadHandler:
    """Orchestrates notification read-state updates."""
    ...
    async def handle(
        ...
        async with self._unit_of_work_factory() as unit_of_work:
            ...
            validate_read_state_transition(notification, read=command.request.read)
        ...
        return NotificationMapper.to_dto(updated)
