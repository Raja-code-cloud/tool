"""Search analytics query handler."""
...
from cloud_content_hub.application.analytics.queries import SearchAnalyticsQuery
...
class SearchAnalyticsHandler:
    """Searches analytics observations and post performance."""
    ...
    async def handle(
        ...
        async with self._unit_of_work_factory() as unit_of_work:
            ...
            page = await analytics_repository.search(
                AnalyticsSearchCriteria(
                    workspace_id=actor.workspace_id,
                    query=query.query,
