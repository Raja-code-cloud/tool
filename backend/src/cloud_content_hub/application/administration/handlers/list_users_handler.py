...
from cloud_content_hub.application.administration.queries import ListUsersQuery
...
class ListUsersHandler:
    """Lists users within an administrative scope."""
    ...
    async def handle(
    ...
    ) -> PagedResultDto[UserSummaryResponse]:
        ...
        items = tuple(AdministrationMapper.to_user_summary_dto(record) for record in page.items)
