"""Get AI providers query handler."""
...
from cloud_content_hub.application.administration.queries import GetAIProvidersQuery
...
class GetAIProvidersHandler:
    """Retrieves AI provider status summaries."""
    ...
    async def handle(
        ...
        providers = await self._provider_health_port.list_providers(
            ProviderHealthCriteria(
                ...
                provider_types=frozenset({ProviderType.AI}),
