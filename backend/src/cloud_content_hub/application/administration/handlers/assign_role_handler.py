...
from cloud_content_hub.application.administration.commands import AssignRoleCommand
from cloud_content_hub.application.administration.events import RoleAssigned
...
class AssignRoleHandler:
    """Assigns a role to a workspace membership."""
    ...
    async def handle(self, actor: ActorContext, command: AssignRoleCommand) -> None:
