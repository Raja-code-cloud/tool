"""Enable maintenance mode command handler."""
...
from cloud_content_hub.application.administration.commands import EnableMaintenanceModeCommand
...
class EnableMaintenanceModeHandler:
    ...
    async def handle(
        self,
        actor: ActorContext,
        command: EnableMaintenanceModeCommand,
        ...
        async with self._unit_of_work_factory() as unit_of_work:
            ...
            validate_maintenance_transition(current_enabled=current.enabled, requested_enabled=True)
            ...
            await self._audit_service.record_success(
                ...
                safe_diff={"enabled": True, "message": command.request.message},
            )
