"""Copy asset command handler."""

from __future__ import annotations

from collections.abc import Callable

from cloud_content_hub.application.assets.commands import CopyAssetCommand
...
from cloud_content_hub.application.assets.validators.asset_validator import validate_copy
from cloud_content_hub.application.shared.actor import ActorContext
from cloud_content_hub.application.shared.authorization import require_permission
from cloud_content_hub.application.shared.interfaces.unit_of_work import IUnitOfWork


class CopyAssetHandler:
    """Orchestrates copying an asset within a workspace."""
    ...
    async def handle(self, actor: ActorContext, command: CopyAssetCommand) -> AssetDto:
        ...
        async with self._unit_of_work_factory() as unit_of_work:
            ...
            validate_copy(asset, command.request)
            copied = await asset_repository.copy(
                workspace_id=actor.workspace_id,
                source_asset_id=command.asset_id,
        ...
        return await self._mapper.to_dto(copied)
