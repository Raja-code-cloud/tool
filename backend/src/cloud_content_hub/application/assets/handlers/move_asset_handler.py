"""Move asset command handler."""

from __future__ import annotations

from collections.abc import Callable

from cloud_content_hub.application.assets.commands import MoveAssetCommand
...
from cloud_content_hub.application.assets.validators.asset_validator import validate_move
...
class MoveAssetHandler:
    """Orchestrates moving an asset within a workspace."""
    ...
    async def handle(self, actor: ActorContext, command: MoveAssetCommand) -> AssetDto:
        ...
        async with self._unit_of_work_factory() as unit_of_work:
            ...
            validate_move(asset, command.request)
            moved = await asset_repository.move(
                workspace_id=actor.workspace_id,
                asset_id=command.asset_id,
        ...
        return await self._mapper.to_dto(moved)
