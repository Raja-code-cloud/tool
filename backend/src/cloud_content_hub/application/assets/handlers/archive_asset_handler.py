"""Archive asset command handler."""

from __future__ import annotations

from collections.abc import Callable

from cloud_content_hub.application.assets.commands import ArchiveAssetCommand
...
from cloud_content_hub.application.assets.validators.asset_validator import validate_archive
...
class ArchiveAssetHandler:
    """Orchestrates asset archival."""
    ...
    async def handle(self, actor: ActorContext, command: ArchiveAssetCommand) -> AssetDto:
        ...
        async with self._unit_of_work_factory() as unit_of_work:
            ...
            archived = await asset_repository.update_lifecycle_status(
                workspace_id=actor.workspace_id,
                asset_id=command.asset_id,
        ...
        return await self._mapper.to_dto(archived)
