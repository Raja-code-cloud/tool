...
export const DENSITY_OPTIONS = [
  {
    value: "comfortable",
    label: "Comfortable",
    description: "Roomier spacing across tables and lists.",
  },
...
export const NOTIFICATION_PREFERENCES: readonly NotificationPreference[] = [
  {
    ...
    description: "Posts published, failed, or awaiting approval.",
    email: true,
    inApp: true,
  },
  {
    id: "ai",
    label: "AI generation",
    description: "Completed generations and quota warnings.",
    email: false,
    inApp: true,
  },
  {
  ...
  },
  {
    id: "billing",
    label: "Billing",
    description: "Invoices, plan changes, and payment failures.",
    email: true,
    inApp: false,
  },
  {
    ...
    description: "New features and monthly changelog digest.",
    email: false,
    inApp: false,
  },
];
...
export const ACTIVE_SESSIONS: readonly SessionRecord[] = [
  {
    ...
    location: "Pune, IN",
    lastActive: "2026-08-02T07:40:00.000Z",
    isCurrent: true,
  },
  {
    id: "s-2",
    ...
    lastActive: "2026-08-01T16:12:00.000Z",
    isCurrent: false,
  },
  {
    id: "s-3",
    device: "CCH AI iOS app",
    location: "Mumbai, IN",
    lastActive: "2026-07-30T09:05:00.000Z",
    isCurrent: false,
  },
];
...
export const API_KEYS: readonly ApiKeyRecord[] = [
  {
    id: "k-1",
    label: "Production publisher",
    maskedKey: "cch_live_••••••••••••4f2a",
    scope: "write",
    createdAt: "2026-02-14T10:00:00.000Z",
    lastUsedAt: "2026-08-02T06:55:00.000Z",
  },
  {
    id: "k-2",
    label: "Analytics export",
    maskedKey: "cch_live_••••••••••••91c7",
    scope: "read",
    createdAt: "2026-05-03T10:00:00.000Z",
    lastUsedAt: "2026-07-29T22:10:00.000Z",
  },
  {
    id: "k-3",
    label: "Staging sandbox",
    maskedKey: "cch_test_••••••••••••0b38",
    scope: "admin",
